...
namespace Gecko
{
    void OrdersViewerWidget::ProcessEvent(Rml::Event& event)
    {
    }
    ...
    void OrdersViewerWidget::init_events(Rml::ElementDocument* document)
    {
        m_document = document;
    }

    void OrdersViewerWidget::deinit_events(Rml::ElementDocument* document)
    {
    }
