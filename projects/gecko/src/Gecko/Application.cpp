...
namespace Gecko
{
    boost::program_options::variables_map Application::parse_options(int argc, char* argv[], const std::string& default_configuration, const std::string& default_map)
    {
    ...
    std::string Application::get_option(const boost::program_options::variables_map& options, const std::string& name)
    {
